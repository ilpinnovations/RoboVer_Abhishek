...
public class NewsBingAsyncHelper extends AsyncTask<String, Void, String>{


    private ServiceResponse mServiceResponse;
    public NewsBingAsyncHelper(ServiceResponse serviceResponse){
    ...
    protected String doInBackground(String... params) {
        ...
        try
        {
            ...
            builder.setParameter("Category", "Sports");
